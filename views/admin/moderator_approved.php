            ...
            <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand">Moderator Approved</a>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card card-plain">
                            ...
                            <div class="card-header">
                                <h4 class="card-title">Old Age Home Moderator</h4>
                                <p class="card-category">Approve Moderator</p>
                            </div>
                            <div class="card-body">
                                <div class="scroll-content" style="height: 310px;">
                                    <table class="table table-hover">
                                        ...
                                        $status = $dataManipulation->moderator();
                                        if ($status){
                                            foreach ($status as $data){
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href='../dataprocess/process.php?active_id=<?php echo $data->id?>' class="btn bg-success"><i class="fa fa-clipboard-check"></i></a>
