                                ...
                                <div class="scroll-content" style="height: 300px;">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <div style="margin: 0 50px;margin-top: 100px" class="alert alert-warning alert-with-icon alert-dismissible fade show" data-notify="container">

                                                <span data-notify="icon" class="nc-icon nc-bell-55"></span>
                                                <span data-notify="message">No member has been left yet</span>
